...
export function GroupAppBar({ 
  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-between bg-white px-4 py-3.5 border-b border-gray-100/60 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex items-center gap-0.5">
        <button 
          ...
          className={cn(
            ...
            isMeetActive ? "bg-[#6366f1] text-white animate-pulse" : "bg-[#f3f0ff] text-[#6366f1]"
          )}
        >
          <Video className="h-[18px] w-[18px] fill-current stroke-[2.5]" />
          <span className="text-[14px] font-bold tracking-tight">Meet</span>
        </button>
        <button className="grid h-[42px] w-[42px] shrink-0 place-items-center rounded-full text-gray-700 active:scale-95 transition-transform hover:bg-gray-100">
          <Search className="h-[22px] w-[22px] stroke-[2.5]" />
        </button>
        <button className="grid h-[42px] w-[42px] shrink-0 place-items-center rounded-full text-gray-700 active:scale-95 transition-transform hover:bg-gray-100">
          <MoreVertical className="h-[22px] w-[22px] stroke-[2.5]" />
        </button>
      </div>
    </div>
  );
